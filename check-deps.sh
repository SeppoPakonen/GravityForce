...
if [ "$MISSING_DEPS" = "1" ]; then
    ...
    echo "  sudo apt-get install liblua5.3-dev libtolua++5.1-dev liballegro5-dev liballegro-acodec5-dev"
    ...
    echo "  sudo dnf install lua-devel tolua++-devel allegro5-devel libnet-devel"
    echo ""
