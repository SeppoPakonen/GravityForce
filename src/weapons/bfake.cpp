...
bulletFake::bulletFake(gsPlayer *p,  int pmode, int pupgrade)
{
  // bullet init
...
bulletFake::bulletFake(long psig, int enr, int px, int py, float pxspd, float pyspd, int pstrength, int pshield, int phull, float puser, int pupgrade)
{
  // bullet init
  type = W_FAKE;
  by_player = psig;
...
bulletFake::~bulletFake()
{
}

void bulletFake::move()
{
  Bullet::move();
...
void bulletFake::move(int no_trail)
{
  x += xspd;
  y -= yspd;
...
void bulletFake::draw(gsMap *m)
{
}

void bulletFake::draw(BITMAP *m)
{
}


int bulletFake::check_collisions()
{
...
int bulletFake::check_map_collisions(gsMap *m)
{
