...
//-----------------------------------------------------------------------------
int AStar::FindPath (int startingX, int startingY, int targetX, int targetY)
{
...
void AStar::ReadPath(int currentX,int currentY, int pixelsPerFrame)
{
/*
...
//-----------------------------------------------------------------------------
int AStar::ReadPathX(int pathLocation)
{
	int x;
	if (pathLocation <= pathLength)
	{
...
//-----------------------------------------------------------------------------
int AStar::ReadPathY(int pathLocation)
{
	int y;
	if (pathLocation <= pathLength)
	{
...
// creates the walkability array with the GS playmap
void AStar::create_from_playmap(gsMap *map)
{
  for (int x=0; x < mapWidth; x++)
    for (int y=0; y < mapHeight; y++)
    {
      if (map->is_tile(x*tileSize+tileSize/2, y*tileSize+tileSize/2))
